...
const utils = trpc.useUtils()
  ...
  return (
    <div>
      <button onClick={() => setModal(true)} className="px-4 py-2 bg-blue-600 text-white rounded">Following {!data ? 0 : data?.length}</button>
      {modal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl max-h-[80vh] w-[90%] max-w-md overflow-y-auto shadow-lg relative">
            ...
            <div className="flex justify-between mb-4">
                <h2 className="text-black text-xl font-semibold">Following</h2>
